...
public class ReactiveNetwork {
  ...
  public static Flow<Connectivity> observeNetworkConnectivity(final Context context) {
  ...
  public static Flow<Boolean> observeInternetConnectivity() {
   ...
   */
  //@RequiresPermission(Manifest.permission.INTERNET)
  protected static Flow<Boolean> observeInternetConnectivity(
